    ...
    <li key={post._id} className="py-4">
      <article className="">
        <Link
          ...
          prefetch
          className="flex flex-col items-center bg-white border border-zinc-200 rounded-lg shadow md:flex-row hover:bg-zinc-100 dark:border-zinc-700 dark:bg-zinc-800 dark:hover:bg-zinc-700"
        >
          <Image
